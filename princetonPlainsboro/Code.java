...
enum Code {
    ...
    //V("Visite au domicile du malade par le médecin généraliste, le chirurgien-dentiste omnipraticien ou la sage-femme.", 200),
    ...
    //AIS("Actes infirmiers de soins. La lettre clé AIS est applicable aux séances de soins infirmiers et aux gardes au domicile des malades.", 200),
