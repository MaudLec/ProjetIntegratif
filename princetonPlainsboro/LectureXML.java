...
//                writer.writeCharacters(dm.getMedecins().get(i).toXML());
...
//                writer.writeCharacters(dm.getPatients().get(i).toXML());
...
//                writer.writeCharacters(dm.getFiche(i).toXML());
...
//    }
    ...
    public void editerDossier() {
        ...
        try {
            XMLStreamWriter writer = factory.createXMLStreamWriter(new FileWriter("src/donnees/" + nomFichier));
            writer.writeStartDocument();
            writer.writeCharacters(dm.toXML());
            writer.writeEndDocument();
            writer.flush();
            writer.close();
        } catch (XMLStreamException e) {
